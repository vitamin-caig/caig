// Original tables from UnrealSpeccy

const BYTE CPU::pMask[8] = {1, 2, 4, 8, 16, 32, 64, 128};

const BYTE CPU::pINCF[256] = {
...
BYTE CPU::pADCF[0x20000];
BYTE CPU::pSBCF[0x20000];
BYTE CPU::pCPF[0x10000];
BYTE CPU::pLogF[0x100];
BYTE CPU::pRLCAF[0x100];
BYTE CPU::pRRCAF[0x100];
BYTE CPU::pROLF[0x100];
BYTE CPU::pRORF[0x100];
